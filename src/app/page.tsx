  ...
  return (
    <>
      ...
      <main className="pt-16">
        ...
        <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden px-4 sm:px-8">
          ...
          <div className="relative z-10 max-w-5xl text-center">
            ...
            <h1 className="font-headline text-4xl sm:text-5xl md:text-7xl font-extrabold tracking-tighter mb-6 leading-[0.9] text-on-surface">
            ...
            <p className="max-w-2xl mx-auto text-base sm:text-lg md:text-xl text-on-surface-variant font-light mb-10 leading-relaxed px-4">
              The Pulse On AI delivers precision-engineered intelligence across the AI and Robotics frontier. Real-time data, neural insights, and the blueprints of tomorrow.
            </p>
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 px-4">
              <Link href="/news" className="w-full sm:w-auto px-8 py-4 bg-primary text-on-primary-container font-headline font-bold uppercase tracking-widest rounded-md hover:scale-105 transition-all shadow-[0_0_20px_rgba(129,236,255,0.3)] text-center">
                Initialize Feed
              </Link>
              <Link href="/training" className="w-full sm:w-auto px-8 py-4 bg-surface-container-highest text-primary font-headline font-bold uppercase tracking-widest rounded-md border border-primary/10 hover:bg-surface-container transition-all text-center">
                View Training
              </Link>
            </div>
          </div>
        ...
        <section className="py-16 sm:py-24 px-4 sm:px-8 max-w-7xl mx-auto">
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-end mb-12 border-b border-outline-variant/10 pb-6 gap-4">
            <div>
              ...
              <h2 className="font-headline text-3xl sm:text-4xl font-bold tracking-tight mt-2">Neural Network News</h2>
            </div>
            <Link href="/news" className="flex items-center gap-2 text-primary font-headline text-xs font-bold uppercase tracking-widest hover:translate-x-1 transition-transform">
              All Updates <span className="material-symbols-outlined text-sm">arrow_forward</span>
            </Link>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
            <Link href="/news" className="md:col-span-8 group relative overflow-hidden rounded-xl bg-surface-container aspect-video block">
              ...
              <div className="absolute bottom-0 p-4 sm:p-8">
                ...
                <h3 className="font-headline text-xl sm:text-3xl font-bold leading-none mb-4 max-w-xl">DeepMind&apos;s New Model Achieves 99% Logical Reasoning</h3>
                <p className="text-on-surface-variant line-clamp-2 max-w-lg mb-6 text-sm sm:text-base">The latest architecture demonstrates near-human cognitive flexibility in abstract problem-solving environments.</p>
            ...
            <div className="md:col-span-4 flex flex-col gap-6">
              <Link href="/news" className="p-6 bg-surface-container-low rounded-xl border-l-4 border-primary hover:bg-surface-container transition-colors block">
              ...
              <Link href="/news" className="p-6 bg-surface-container-low rounded-xl hover:bg-surface-container transition-colors block">
        ...
        {/* Featured Blog Posts */}
        <section className="py-16 sm:py-24 bg-surface-container-low relative">
          <div className="max-w-7xl mx-auto px-4 sm:px-8">
            <h2 className="font-headline text-3xl sm:text-4xl font-bold tracking-tight mb-16 text-center">Core Research &amp; Synthesis</h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12">
              <Link href="/blogs" className="flex flex-col gap-6 group block">
              ...
              <Link href="/blogs" className="flex flex-col gap-6 group md:translate-y-12 block">
                <div className="relative aspect-[4/5] overflow-hidden rounded-lg bg-surface-container">
        ...
        <section className="py-16 sm:py-32 px-4 sm:px-8 overflow-hidden">
          <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
            <div className="lg:w-1/2 space-y-8">
              ...
              <h2 className="font-headline text-3xl sm:text-5xl font-bold tracking-tighter leading-none">UPGRADE YOUR <br/><span className="text-primary-dim">NEURAL WIRING</span></h2>
              ...
              <Link href="/training" className="mt-8 inline-block px-10 py-5 bg-gradient-to-r from-primary to-primary-container text-on-primary-container font-headline font-bold uppercase tracking-widest rounded-md hover:shadow-[0_0_30px_rgba(129,236,255,0.4)] transition-all">
                Enter Academy
              </Link>
            </div>
            <div className="lg:w-1/2 relative w-full">
              ...
              <div className="relative glass-card border border-outline-variant/20 rounded-2xl p-1 overflow-hidden">
                <img className="rounded-xl w-full h-[300px] sm:h-[500px] object-cover" alt="High tech dark server room with blue lights" src="https://lh3.googleusercontent.com/aida-public/AB6AXuBaxdffxHbBEyDOjDsJ5uaU73GQIIw34BgrCQd6JuZH8B7MJw5eRlabweiFzlYA5YcEXLlq_V2fmhywzGN6Ln4sI1VHKrNQnYZlXaqW7T67bNzcuGgqIqPRr1sYs5Ngd9EVPnAfDLafOyA2-jj_wDnLNf0C751N9tRg1hlRCAF6Rra6KekynF8vSNNbhUDCpJRaHL1oFxpUHjmzy6UOmfBHbRfehryOnaH-UjvZqvarZtqA0Kdm4oDK7gUHcKnZz40EFem_iR87Vst2" crossOrigin="anonymous"/>
        ...
        <section className="py-16 sm:py-24 px-4 sm:px-8 mb-12">
          <div className="max-w-4xl mx-auto bg-primary-container/10 border border-primary/20 rounded-3xl p-6 sm:p-12 relative overflow-hidden text-center">
            ...
            <div className="relative z-10">
              ...
              <h2 className="font-headline text-3xl sm:text-4xl font-bold tracking-tight mb-4">JOIN THE PULSE</h2>
      ...
      <footer className="bg-[#0d0e12] border-t border-[#47484c]/15 mt-auto">
        <div className="flex flex-col md:flex-row justify-between items-center gap-6 max-w-7xl mx-auto py-12 px-4 sm:px-8">
